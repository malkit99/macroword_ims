  ...
  onFilePicked(event){   
    ...
    save(){
          this.$refs.courseForm.validate().then((success) => {
            ...
            data.append("course_code_id", this.course.course_code_id);
            data.append("title",  this.course.title);
            data.append("course_category_id", this.course.course_category_id);
            data.append("batch_id", this.course.batch_id);
            data.append("duration_id",  this.course.duration_id);
            data.append("course_fee_id",  this.course.course_fee_id);
            data.append("duration_id",  this.course.duration_id);
    ...
    clear(){
        ...
        this.course.course_code_id = "",
        this.course.title = "",
        this.course.course_category_id = "",
        this.course.batch_id = "",
        this.course.duration_id = "",
        this.course.course_fee_id = "",
        this.course.duration_id = "",
        this.course_image = "",
